...
ActiveRecord::Schema.define(version: 2020_09_25_053926) do
  ...
  create_table "comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.float "port_rate", default: 0.0, null: false
    t.float "spot_rate", default: 0.0, null: false
    t.index ["admin_id"], name: "index_comments_on_admin_id"
    t.index ["port_id"], name: "index_comments_on_port_id"
    t.index ["user_id"], name: "index_comments_on_user_id"
  end

  create_table "ports", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "name", default: "no-name", null: false
    t.string "address", default: "no-address", null: false
    t.text "information"
    t.text "detail"
    t.text "summary"
    t.string "rep_name1", default: "no-spot-name", null: false
    t.text "rep_info1", null: false
    t.string "rep_name2", default: "no-spot-name", null: false
